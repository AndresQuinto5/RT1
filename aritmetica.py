...
def multMatrices(m1,m2):
    ...
    if len(m1[0]) == len(m2):
        ...
        print("\n Ojo - No se pudo realizar la multiplicación de matrices porque el número de columnas de la primera matriz no es igual al número de filas de la segunda matriz")
        return 0
